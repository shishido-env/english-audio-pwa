...
- [ ] **Step 1: drizzle-orm と Neon ドライバを runtime 依存に追加**
...
- [ ] **Step 2: drizzle-kit を devDependencies に追加**
...
- [ ] **Step 3: インストール後の package.json を確認**
